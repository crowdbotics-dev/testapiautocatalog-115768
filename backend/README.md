...
## Project Structure
    ...
    ├── testapiautocatalog_115768  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_115768`
...
2. Clone this repo and `cd testapiautocatalog_115768`
